...
terminals = {
	...
	1 : [MCNF_Objects_hw3_lowerbound.City("1", 1, -3), MCNF_Objects_hw3_lowerbound.City("1", 2, -1), MCNF_Objects_hw3_lowerbound.City("1", 3, 0), MCNF_Objects_hw3_lowerbound.City("1", 4, 0), MCNF_Objects_hw3_lowerbound.City("1", 5, 0), MCNF_Objects_hw3_lowerbound.City("1", 6, -3), MCNF_Objects_hw3_lowerbound.City("1", 7, -1), MCNF_Objects_hw3_lowerbound.City("1", 8, 0), MCNF_Objects_hw3_lowerbound.City("1", 9, 0), MCNF_Objects_hw3_lowerbound.City("1", 10, 0)],
	2 : [MCNF_Objects_hw3_lowerbound.City("2", 1, 0), MCNF_Objects_hw3_lowerbound.City("2", 2, 0), MCNF_Objects_hw3_lowerbound.City("2", 3, 0), MCNF_Objects_hw3_lowerbound.City("2", 4, -3), MCNF_Objects_hw3_lowerbound.City("2", 5, 0), MCNF_Objects_hw3_lowerbound.City("2", 6, 1), MCNF_Objects_hw3_lowerbound.City("2", 7, 0), MCNF_Objects_hw3_lowerbound.City("2", 8, 0), MCNF_Objects_hw3_lowerbound.City("2", 9, -3), MCNF_Objects_hw3_lowerbound.City("2", 10, 0)],
